...
std::string hexEncode(const std::string &input); // Кодирование строки в шестнадцатеричный формат [НЕ ИСПОЛЬЗУЕТСЯ]
...
std::string formatTime(long seconds); // Форматирование времени в формате HH:MM:SS [НЕ РАБОТАЕТ]
